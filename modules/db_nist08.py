...
class DBNIST08(DBModule):
    ...
    def _get_elements(self):
        ...
        for index in self.dataunits:
            ...
            # there should be a single GT file here
            gt_file = common.listdir(self.gt_dir, self.DATAUNITS_RE[index])[0]

            # compare GT file name and Data file name without "_CHxx" ending
            if gt_file != source_files[0][:-5]:
                raise VADpyError("GT file's and Data file's name mismatch: {0}".format(gt_file))
