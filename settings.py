...
MACROS = {   
    ...
    'isingle' : 'iosingled action=read frame-len={framelen} k=1', 
    ...
    'amr1' : 'vadamr outdir="{outdir}/amr1" exec-path="{bindir}/amr/amr1" ',
    'amr2' : 'vadamr outdir="{outdir}/amr2" exec-path="{bindir}/amr/amr2" ',
